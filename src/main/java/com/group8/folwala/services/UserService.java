...
public class UserService {
    ...
    private final String USER_FILE_PATH = System.getenv("APPDATA") + "\\Folwala\\users.dat";
    private final String SESSION_FILE_PATH = System.getenv("APPDATA") + "\\Folwala\\session.dat";
